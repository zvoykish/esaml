...
-spec generate_authn_request(IdpURL :: string(), string() | undefined, esaml:sp()) -> #xmlElement{}.
generate_authn_request(IdpURL, User_Name_Id, SP = #esaml_sp{metadata_uri = MetaURI, consume_uri = ConsumeURI}) ->
